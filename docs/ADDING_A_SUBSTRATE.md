...
Version 0.1.0 uses an explicit in-package registry. Adding a substrate requires
...
Registration is intentionally explicit in version 0.1.0. There is no dynamic

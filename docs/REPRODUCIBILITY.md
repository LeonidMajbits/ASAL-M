...
For exact byte reproduction of the v0.1.4 public evidence, install the pinned
direct dependencies:
...
The exact-byte guarantee applies to the documented v0.1.4 release constraints
